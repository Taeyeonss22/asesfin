...
<div style="font-family: serif; font-size: 11pt; line-height: 1.5; text-align: justify;">
...
<div style="font-family: serif; font-size: 11pt; line-height: 1.5; text-align: justify;">
  ...
  <p><b>III.-</b> Declara "EL ACREDITADO", ser mexicano(a), mayor de edad, con domicilio en {{domicilio_acreditado}}, y manifiesta estar interesado en recibir las asesorías administrativas y servicios profesionales o apoyo económico para el impulso y fortalecimiento de sus actividades productivas, las cuales son lícitas y rentables.<br>
  Que "EL ACREDITADO" y "DEUDOR SOLIDARIO" están plenamente conscientes de los derechos y obligaciones que por este medio contraen, estando de acuerdo en recibir los servicios profesionales y de así ser necesario el apoyo económico que le otorga "{{empresa_nombre}}", bajo los términos y condiciones que se establecen en el presente instrumento.<br>
  Que previo a la celebración del presente contrato, han convenido en todos y en cada uno de los términos en cuanto a los honorarios, plazo, intereses ordinarios y moratorios, descuentos, cesión, causas de vencimiento anticipado, rescate de crédito, tribunales competentes, etc.<br>
...
<div style="font-family: serif; font-size: 11pt; line-height: 1.5; text-align: justify;">
  ...
  - Todas las demás que sean aplicables y que determine "{{empresa_nombre}}", previo aviso que se les dé por escrito o por conducto de alguno de sus representantes.</p>
...
async function seed() {
  // First clear existing plantillas if they exist
  await supabase.from('plantillas_contratos').delete().neq('id', 'dummy'); // delete all
